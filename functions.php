...
if ( ! function_exists( 'saltato_setup' ) ) :
	 ...
	 */
	function saltato_setup() {
		/*
		 * Make theme available for translation.
		 * Translations can be filed in the /languages/ directory.
		 * If you're building a theme based on saltato, use a find and replace
		 * to change 'saltato' to the name of your theme in all the template files.
		 */
		load_theme_textdomain( 'saltato', get_template_directory() . '/languages' );
		...
		add_theme_support(
			'custom-background',
			apply_filters(
				'saltato_custom_background_args',
				array(
...
add_action( 'after_setup_theme', 'saltato_setup' );
...
function saltato_scripts() {
	wp_enqueue_style( 'saltato-style', get_stylesheet_uri(), array(), _S_VERSION );
	wp_style_add_data( 'saltato-style', 'rtl', 'replace' );

	wp_enqueue_script( 'saltato-navigation', get_template_directory_uri() . '/js/navigation.js', array(), _S_VERSION, true );
