...
<div class="search" data-module="search">
	<form action="<?php echo esc_url( home_url( '/' ) ); ?>" method="get" role="search" class="search__form govuk-!-margin-bottom-4">
		...
		<input type="text" id="search" name="s" class="govuk-input govuk-!-margin-bottom-0 search__input" aria-controls="search-results" placeholder="<?php esc_html_e( 'Search', 'saltato' ); ?>" value="<?php echo get_search_query(); ?>">
